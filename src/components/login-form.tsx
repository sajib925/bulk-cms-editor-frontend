...
export function LoginForm({ className, ...props }: React.ComponentPropsWithoutRef<"div">) {
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card>
        <CardHeader className="text-center">
          <CardTitle className="flex w-full">
            <a href="#" className="mx-auto flex items-center gap-2 self-center font-medium">
      ...
      <div className="text-balance text-center text-xs text-zinc-500 dark:text-zinc-400 [&_a]:underline [&_a]:underline-offset-4 [&_a]:hover:text-zinc-900 dark:[&_a]:hover:text-zinc-50">
